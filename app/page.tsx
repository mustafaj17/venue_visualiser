      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="relative flex-1">
          ...
          <section className="mx-auto max-w-7xl px-6 pt-20 pb-16 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border bg-white/70 px-3 py-1.5 text-sm text-gray-700 backdrop-blur">
              <Sparkles className="h-3.5 w-3.5" />
              <span>New: Smarter scene styling</span>
            </div>
            <h1 className="mt-6 text-5xl font-bold tracking-tight text-gray-900 md:text-6xl lg:text-7xl">
        ...
        <footer className="border-t bg-white/60 backdrop-blur">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 text-sm text-gray-600">
